    ...
    <div className="bg-white p-4 space-y-6">
      ...
      <div className="flex gap-4 items-center">
        <Select value={month} onValueChange={setMonth}>
          <SelectTrigger className="w-28 border-2 border-adminLayout-grey-300 items_center justify-center gap-3 pt-3">
      ...
      {/* Statistic summary */}
      <div className="bg-adminLayout-grey-250 rounded-lg font-medium text-adminLayout-grey-600">
        <div className="p-6 flex justify-between text-center">
          <div>
            <div className="text-sm text-gray-500 mb-1">Best-seller room</div>
      ...
      {/* Data table */}
      <div className="overflow-hidden rounded-xl border border-adminLayout-grey-250">
        <table className="min-w-full table-fixed text-left text-sm bg-white">
          <thead className="bg-adminLayout-grey-10 text-adminLayout-grey-20 border">
            <tr>
            ...
            {loading ? (
              ...
              rate.map((item) => (
                <tr key={item.room_id} className="border-t">
                  ...
                  <td className="p-3">{item.deal_name || 'No deal'}</td>
