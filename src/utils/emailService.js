...
const sendBookingEmail = async ({
  ...
  const mailOptions = {
    ...
    html: `
      ...
      <p><strong>#Booking ${booking.booking_id}</strong> - You booked successfully!</p>
      <ul>
      ...
      <p>Check-in time: <strong>after 14:00</strong> on the day of arrival</p>
      <p>Check-out time: <strong>before 12:00</strong> on the day of departure</p>
    `,
  };
